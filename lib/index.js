 ...
 * @returns {Function}
 */
function _getList(name, params, options) {
  var _checkResourceName = checkResourceName(name, params, options);

  var _params = _checkResourceName._params;
  var _options = _checkResourceName._options;


  return function (dispatch) {
    _options = _ramda2.default.merge({ resourceType: defaults.list.name }, _options);
    dispatchRequest(_getList, name, _params, _options, dispatch);
  };
}
...
function _get(name) {
  ...
  var _checkResourceName2 = checkResourceName(name, params, options);

  var _params = _checkResourceName2._params;
  var _options = _checkResourceName2._options;

  return function (dispatch) {
    options = _ramda2.default.merge({ resourceType: defaults.item.name }, options);
    return dispatchRequest(_get, name, _params, _options, dispatch);
  };
}
...
function _post(name) {
  ...
  var _checkResourceName3 = checkResourceName(name, params, options);

  var _params = _checkResourceName3._params;
  var _options = _checkResourceName3._options;


  return function (dispatch) {
    options = _ramda2.default.merge({ resourceType: defaults.item.name }, options);
    dispatchRequest(_post, name, _params, _options, dispatch);
  };
}
...
function _put(name) {
  ...
  var _checkResourceName4 = checkResourceName(name, params, options);

  var _params = _checkResourceName4._params;
  var _options = _checkResourceName4._options;


  return function (dispatch) {
    options = _ramda2.default.merge({ resourceType: defaults.item.name }, options);
    dispatchRequest(_put, name, _params, _options, dispatch);
  };
}
...
function _del(name) {
  ...
  var _checkResourceName5 = checkResourceName(name, params, options);

  var _params = _checkResourceName5._params;
  var _options = _checkResourceName5._options;


  return function (dispatch) {
    options = _ramda2.default.merge({ resourceType: defaults.item.name }, options);
    dispatchRequest(_del, name, _params, _options, dispatch);
  };
}
...
function dispatchRequest(request, name, params, options, dispatch) {
  ...
  (0, _superagent2.default)(method.name, resource.buildUrl(params)).set(headers).query(query).send(payload).type(contentType).end(function (err, resp) {
    var on = generateEvents(options, resource, request);
    if (err === null) {
      resp = on("Data")(resp);
      on("Response")(resp, dispatch, _ramda2.default.merge(options, actions(method.OK)));
